...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '5b64a2dda62b83fd2f93efd663ad2f28',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'node4doc <app@flatlogic.app>',
  ...
  project_uuid: 'b13760eb-8a7a-4531-a50b-763955edb8d0',
  flHost:
...
config.pexelsQuery = 'calm workspace with documents';
config.host =
