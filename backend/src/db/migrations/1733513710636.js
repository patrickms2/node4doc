module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('folders', 'ownerId', { transaction });

      await queryInterface.removeColumn('folders', 'status', { transaction });

      await queryInterface.removeColumn('folders', 'favorite', { transaction });

      await queryInterface.removeColumn('folders', 'color', { transaction });

      await queryInterface.removeColumn('folders', 'type', { transaction });

      await queryInterface.removeColumn('folders', 'name', { transaction });

      await queryInterface.removeColumn('documents', 'status', { transaction });

      await queryInterface.removeColumn('documents', 'type', { transaction });

      await queryInterface.removeColumn('documents', 'current_ownerId', {
        transaction,
      });

      await queryInterface.removeColumn('documents', 'ownerId', {
        transaction,
      });
