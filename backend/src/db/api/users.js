...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.documents_owner = await users.getDocuments_owner({
      transaction,
    });

    output.documents_current_owner = await users.getDocuments_current_owner({
      transaction,
    });

    output.folders_owner = await users.getFolders_owner({
      transaction,
    });
