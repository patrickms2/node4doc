...
const CardUsers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_FOLDERS');
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/folders/folders-edit/?id=${item.id}`}
                    pathView={`/folders/folders-view/?id=${item.id}`}
              ...
              <dl className='divide-y  divide-stone-300   dark:divide-dark-700 px-6 py-4 text-sm leading-6 h-64 overflow-y-auto'>
                ...
                <div className='flex justify-between gap-x-4 py-3'>
                  ...
                  <dd className='flex items-start gap-x-2'>
                    <div className='font-medium line-clamp-4'>
                      {dataFormatter
                        .documentsManyListFormatter(item.documents)
                        .join(', ')}
                    </div>
                  </dd>
                </div>
