      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{documents?.owner?.firstName ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>CurrentOwner</p>

            <p>{documents?.current_owner?.firstName ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Type</p>
            <p>{documents?.type ?? 'No data'}</p>
          </div>
