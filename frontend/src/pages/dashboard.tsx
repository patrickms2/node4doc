...
const Dashboard = () => {
  ...
  const [folders, setFolders] = React.useState('Loading...');
  ...
  async function loadData() {
    const entities = ['users', 'documents', 'folders', 'roles', 'permissions'];
    const fns = [setUsers, setDocuments, setFolders, setRoles, setPermissions];
