    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Documents Owner</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.documents_owner &&
                      Array.isArray(users.documents_owner) &&
                      users.documents_owner.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
          ...
          <>
            <p className={'block font-bold mb-2'}>Documents CurrentOwner</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.documents_current_owner &&
                      Array.isArray(users.documents_current_owner) &&
                      users.documents_current_owner.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.documents_current_owner?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Folders Owner</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.folders_owner &&
                      Array.isArray(users.folders_owner) &&
                      users.folders_owner.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(`/folders/folders-view/?id=${item.id}`)
                          }
                        >
                          <td data-label='name'>{item.name}</td>
                          ...
                          <td data-label='favorite'>
                            {dataFormatter.booleanFormatter(item.favorite)}
                          </td>
